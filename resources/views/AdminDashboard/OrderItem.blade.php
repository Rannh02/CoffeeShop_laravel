...
<body>
    ...
    <script type="module" src="{{ asset('js/DashboardsTime.js') }}"></script>
    <script type="module" src="{{ asset('js/buttontransition.js') }}"></script>
    <script type="module" src="{{ asset('js/AddProductModal.js') }}"></script>
    <script type="module" src="{{ asset('js/UpdateProductModal.js') }}"></script>
    <script src="{{ asset('js/DeleteProductModal.js') }}"></script>
</body>
</html>