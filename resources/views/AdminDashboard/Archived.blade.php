        ...
        <aside class="sidebar">
          <nav class="sidebar-nav">
            <a href="{{ route('admin.dashboard') }}" class="nav-item"><i class="bi bi-list"></i> Dashboard</a>
                ...
                <a href="{{ route('admin.archived') }}" class="nav-item active"><i class="bi bi-person-x"></i> Employee Archived</a>
          ...
          <div class="product-header">
            ...
            <div class="search-container">
                <input 
                    ...
                    id="searchInput" 
                    class="search-input" 
                    placeholder="Search for Archived Employee."
                    ...
                    @if ($employees->count() > 0)
                      @foreach ($employees as $employee)
                        <tr>
                          ...
                          <td>
                              <form action="{{ route('admin.employee.restore', $employee->Employee_id) }}" method="POST">
                                  @csrf
